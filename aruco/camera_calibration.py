...
calib_imgs_path = root.joinpath("/home/ichikura/rosielab/aruco/images/")

# For validating results, show aruco board to camera.
aruco_dict = aruco.getPredefinedDictionary( aruco.DICT_6X6_250 )

#Provide length of the marker's side
markerLength = 3.4  # Here, measurement unit is centimetre.

# Provide separation between markers
markerSeparation = 0.7   # Here, measurement unit is centimetre.

# create arUco board
board = aruco.GridBoard_create(4, 3, markerLength, markerSeparation, aruco_dict)
